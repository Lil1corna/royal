...
Подробная инструкция по настройке переменных окружения и деплою: **[SETUP.md](./SETUP.md)** (включая **rate limiting** через Upstash Redis для многоинстансного деплоя).
