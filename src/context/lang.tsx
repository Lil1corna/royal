...
export const translations = {
  ...
  priceRange: t('Qiymət aralığı', 'Диапазон цен', 'Price range'),
  sortBy: t('Sıralama', 'Сортировка', 'Sort by'),
  sortDefault: t('Əsas', 'По умолчанию', 'Default'),
  sortPriceLow: t('Ucuzdan bahaya', 'Сначала дешевле', 'Price: Low to High'),
  sortPriceHigh: t('Bahadan ucuza', 'Сначала дороже', 'Price: High to Low'),
  sortNameAZ: t('A-dan Z-yə', 'А-Я', 'A-Z'),
  sortDiscount: t('Endirim', 'Скидка', 'Discount'),
  quickView: t('Sürətli baxış', 'Быстрый просмотр', 'Quick view'),
  filters: t('Filtrlər', 'Фильтры', 'Filters'),
  clearFilters: t('Təmizlə', 'Сбросить', 'Clear'),
  showFilters: t('Filtrlər', 'Фильтры', 'Filters'),
  hideFilters: t('Gizlət', 'Скрыть', 'Hide'),
  productsFound: t('məhsul tapıldı', 'товаров найдено', 'products found'),
  noProductsFound: t('Məhsul tapılmadı', 'Товары не найдены', 'No products found'),
  minPrice: t('Min', 'Мин', 'Min'),
  maxPrice: t('Maks', 'Макс', 'Max'),
  onlyInStock: t('Yalnız stokda', 'Только в наличии', 'In stock only'),
  onlyDiscounted: t('Endirimlilər', 'Со скидкой', 'On sale'),
