...
export default function Footer() {
  ...
  return (
    <motion.footer
      ...
      className="mt-auto border-t border-white/5 bg-[rgba(5,13,26,0.88)] text-white"
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 lg:px-16 py-8 sm:py-10 lg:py-12 pb-24 md:pb-12">
